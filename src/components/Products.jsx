    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-flow-cols-2 gap-12 text-white">
        {products.map((product) => (
          <div
            key={product.id}
            className="group shadow-md shadow-thBlue bg-gray-900/70 backdrop-blur-2xl rounded-lg flex flex-col items-center justify-center p-8 duration-300 hover:shadow-lg hover:shadow-thPurple"
          >
            {/* icon */}
            ...
            {/* title and subtitle */}
            <h2 className="text-3xl lg:text-3xl mb-4 capitalize">
              {product.title}
            </h2>
